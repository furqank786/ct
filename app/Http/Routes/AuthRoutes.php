    ...
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get('login', [
                ...
                //'uses'       => '\DynabicCachet\Passport\Controllers\LoginController@redirectToProvider',//'AuthController@showLogin',
            ]);
...
//            ]);
            $router->post('login/callback',[
                'uses'  => '\DynabicCachet\Passport\Controllers\LoginController@handleProviderCallback',
            ] );
        });
    }
}
